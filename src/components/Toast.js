...
const colors = ['#006644', '#BF2600', '#FF8B00', '#505F79'];
const backgroundColors = ['#E3FCEF', '#FFEBE6', '#FFFAE6', '#FFFFFF'];
    ...
    <div>
      {state && (
        ...
        >
          ...
          <div style={{ backgroundColor: iconBackgroundColors[type], paddingTop: 8, width: 32 }}>
            {icons[type]}
          </div>
          <div style={{ padding: 15 }}>{message}</div>
        </div>
      )}
    </div>
  );
